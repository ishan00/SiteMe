...
#type:orange
navbar_orange = {'div':{'class':''}, 'content':{ 1:{'ul':{} , 'content':{ 1:{'li':{}, 'content':{ 1:{'a':{'href':''} ,'content':'' } } } } } } }

#type:flat
navbar_flat = {'div':{'class':''}, 'content':{ 1:{'ul':{} , 'content':{ 1:{'li':{}, 'content':{ 1:{'a':{'href':''} ,'content':'' } } } } } } }

#type:indented
navbar_indented = {'div':{'class':''}, 'content':{ 1:{'ul':{} , 'content':{ 1:{'li':{}, 'content':{ 1:{'a':{'href':''} ,'content':'' } } } } } } }

#type:wrap
navbar_wrap = {'div':{'class':''} , 'content':{ 1:{'span':{'class':'decor'} , 'content':''} , 2:{'nav':{} , 'content':{ 1:{'ul':{'class':'primary'} , 'content':{ 1:{'li':{} , 'content':{ 1:{'a':{'href':''} , 'content':''} , 2:{'ul':{'class':'sub'} , 'content' : {1:{'li':{},'content':{1:{'a':{'href':''}, 'content':''} } } } } } } } } } } } }
#type:toggle
